...
- 作者：Johannes Lenzen、Mohamadreza Rostami、Lichao Wu、Ahmad Sadeghi
- 发表日期：2025-12-29
...
- 证据等级：全文核验
- 全文状态：已完成
- 标签：Microarchitectural Security Testing、RTL & SoC Hardware Fuzzing、Coverage, Oracles & Fuzzing Methodology
- 纳入依据：hardware/processor object: processor, cpu, microarchitecture, microarchitectural；verification/fuzzing method: fuzz, coverage-guided；security relevance: vulnerability
- 论文页面：[https://doi.org/10.48550/arXiv.2512.23438](https://doi.org/10.48550/arXiv.2512.23438)
