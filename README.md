...
- arXiv：用于发现预印本和新近工作
- OpenAlex：用于补充正式出版论文，覆盖 ACM、IEEE、USENIX、NDSS、Springer 等索引来源
- Semantic Scholar：用于补充论文元数据、正式发表 venue、DOI 和开放 PDF 链接
...
默认重点 venue 白名单包括安全顶会/顶刊、体系结构顶会和硬件安全/EDA 会议，例如：
